...
//String url = "jdbc:mysql://localhost:3306/SectionA"; // database name
//String uname = "root";
//String pass = "12345";
...
public class EmployeeDAO {
    ...
    public static int save(Employee e) {
        ...
        try {
            ...
            String query = "INSERT INTO stu(id, name, password, email, country) VALUES (?,?,?,?,?)";
    ...
    public static int update(Employee e) {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                    "UPDATE stu set name=?,password=?,email=?,country=? where id=?");
